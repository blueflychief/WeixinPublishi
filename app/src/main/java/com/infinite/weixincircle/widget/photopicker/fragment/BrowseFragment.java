...
public class BrowseFragment extends Fragment implements PhotoBrowseAdapter.OnImageClickListener {
    ...
    private PhotoBrowseAdapter mPagerAdapter;
    ...
    public static BrowseFragment newInstance(List<String> paths, int currentItem) {
    ...
    public static BrowseFragment newInstance(List<String> paths, int currentItem, int[] screenLocation, int thumbnailWidth, int thumbnailHeight) {

        BrowseFragment f = newInstance(paths, currentItem);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PhotoBrowseAdapter(paths);
...
//        View rootView = inflater.inflate(R.layout.fragment_image_pager, container, false);
        View rootView = inflater.inflate(R.layout.activity_photo_browse, container, false);

        rootView.findViewById(R.id.dv_indicator).setVisibility(View.GONE);
        mViewPager = (HackyViewPager) rootView.findViewById(R.id.pv_viewpager);
...
//    ObjectAnimator colorizer = ObjectAnimator.ofFloat(BrowseFragment.this,
//        "saturation", 0, 1);
...
//        ObjectAnimator.ofFloat(BrowseFragment.this, "saturation", 1, 0);
//    colorizer.setDuration(duration);
//    colorizer.start();
//  }
